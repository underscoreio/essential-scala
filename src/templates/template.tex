...
\definecolor{bookcolor}{HTML}{A0C556}
...
\node[anchor=north west, xshift=-.2cm, yshift=.2cm]
     ...
     {\includegraphics{src/templates/images/hero-left-overlay-white.pdf}};
\end{tikzpicture}

\begin{tikzpicture}[overlay, remember picture]
\node[anchor=south east, xshift=.2cm, yshift=-.2cm]
     at (current page.south east)
     {\includegraphics{src/templates/images/hero-right-overlay-white.pdf}};
\end{tikzpicture}
...
\begin{bottompar}
\begin{center}
\includegraphics[width=5cm]{src/templates/images/brand.pdf}
...
Copies of this, and related topics, can be found at \href{http://underscore.io}{http://underscore.io}.
...
{\fontsize{.5cm}{1em} \raggedright{
MARKETING PARA ONE (template.tex)

}}

{\fontsize{.5cm}{1em} \raggedright{
MARKETING PARA TWO (template.tex)
}}

Topics covered:

\begin{enumerate}
\item TODO (template.tex)
\end{enumerate}

{\fontsize{.5cm}{1em} \raggedright{
MARKETING FOOT (template.tex)
}}
