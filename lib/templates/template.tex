...
\node[anchor=north west, xshift=-.2cm, yshift=.2cm]
     ...
     {\includegraphics{lib/templates/images/hero-left-overlay-white.pdf}};
\end{tikzpicture}

\begin{tikzpicture}[overlay, remember picture]
\node[anchor=south east, xshift=.2cm, yshift=-.2cm]
     at (current page.south east)
     {\includegraphics{lib/templates/images/hero-right-overlay-white.pdf}};
\end{tikzpicture}
...
\begin{bottompar}
\begin{center}
\includegraphics[width=5cm]{lib/templates/images/brand.pdf}
